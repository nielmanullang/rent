...
class SignUpProviderScreen extends React.Component {
  ...
  _changeUsername = (value) => {
    let formItem = this.state.formItem;
    formItem.username = value.toLowerCase();
    this.setState({ formItem });
  };
              ...
              <TouchableOpacity onPress={this._showDateTimePicker}>
                {formItem.tanggalLahir == null ? (
                  ...
                  <Text horizontalColumn>
                    {moment(formItem.tanggalLahir).format("DD-MM-YYYY")}
                  </Text>
                )}
              </TouchableOpacity>
              <DateTimePicker
...
export default SignUpProviderScreen;
